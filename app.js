...
const PAGES = [
  { file: 'index.html',   label: 'Portfolio นางสาวอัจฉรา ทับทิมฉิม' },
  { file: 'page-02.html', label: 'Profile ประวัติส่วนตัว' },
  { file: 'page-03.html', label: 'Statement of Purpose' },
  { file: 'page-04.html', label: 'Academic Record ผลการเรียน' },
  { file: 'page-05.html', label: 'Activities — Engineering Camps' },
  { file: 'page-06.html', label: 'Activities — Academic Workshops 1' },
  { file: 'page-07.html', label: 'Activities — Academic Workshops 2' },
  { file: 'page-08.html', label: 'Activities — Volunteer Activities' },
  { file: 'page-09.html', label: 'Activities — Activities & Leadership' },
  { file: 'page-10.html', label: 'Certificate' },
  { file: 'page-11.html', label: 'Contact' },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function toggleZoomAt(){
    if (scale === 1) { scale = 2.4; } else { scale = 1; posX = 0; posY = 0; }
    applyTransform();
  }
  lbImg.addEventListener('dblclick', () => toggleZoomAt());
